...
lint-py:  ## run python linter with ruff
	python -m ruff check spaday_dagre
	python -m ruff format --check spaday_dagre
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix spaday_dagre
	python -m ruff format spaday_dagre
...
test-py:  ## run python tests
	python -m pytest -v spaday_dagre/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v spaday_dagre/tests --cov=spaday_dagre --cov-report term-missing --cov-report xml
